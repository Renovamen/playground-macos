    ...
    <div className="w-full h-full bg-gray-100 text-gray-700 overflow-scroll px-8 py-6">
      <div className="charapter">
        ...
        <div className="paragraph mt-4">
          Hey there! I'm Xiaohan Zou, <s>a dragon lost in human world</s> now
      ...
      <div className="charapter mt-8">
        ...
        <div className="paragraph mt-4">
          ...
          <ul className="mt-2 list-disc list-inside">
            <li>
              Email: <a className="text-blue-500" href="mailto:renovamenzxh@gmail.com">
                renovamenzxh@gmail.com
              </a> / <a className="text-blue-500" href="mailto:xiaohan.zou@foxmail.com">
                xiaohan.zou@foxmail.com
              </a>
            </li>
            <li>Github: <a className="text-blue-500" href="https://github.com/Renovamen" target="_blank" rel="noreferrer">@Renovamen</a></li>
            <li>知乎: <a className="text-blue-500" href="https://www.zhihu.com/people/chao-neng-gui-su" target="_blank" rel="noreferrer">@Renovamen</a></li>
            <li>Blog: <a className="text-blue-500" href="https://renovamen.ink" target="_blank" rel="noreferrer">renovamen.ink</a></li>
            <li>Linkedin: <a className="text-blue-500" href="https://www.linkedin.com/in/xiaohan-zou-55bba0160" target="_blank" rel="noreferrer">Xiaohan Zou</a></li>
          </ul>
        </div>
      </div>
